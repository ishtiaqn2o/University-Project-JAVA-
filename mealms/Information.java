...
public class Information extends JFrame {
	...
	private JLabel title, email,name,address,contactnum,age;
	private JTextField temail,tname,taddress,tcontactnum,tage;
	private JLabel sex;
...
public Information(){
	...
	//Jlabel..................................
	title=new JLabel("::Enter Member Information::");
...
int i= st.executeUpdate("INSERT INTO information (name,gender,age,address,contact,email) VALUES ('"+val1+"','"+val2+"','"+val3+"','"+val4+"','"+val5+"','"+val6+"')");
...
private void arrangeComponents(){
	...
	temail.setBounds(150+100+10,245+45,250,25);
        ...
        submit.setBounds(150+100+10, 325+45, 100, 25);
        reset.setBounds(150+100+20+100, 325+45, 100, 25);
